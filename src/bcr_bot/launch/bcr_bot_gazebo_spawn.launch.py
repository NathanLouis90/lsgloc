...
def generate_launch_description():
    ...
    front_camera_enabled = LaunchConfiguration("front_camera_enabled", default=True)
    ...
    # i added my own right camera here
    right_camera_enabled = LaunchConfiguration("right_camera_enabled", default=False)
    
    # Path to the Xacro file
    xacro_path = join(bcr_bot_path, 'urdf', 'bcr_bot.xacro')
    #doc = get_xacro_to_doc(xacro_path, {"wheel_odom_topic": "odom", "sim_gazebo": "true", "two_d_lidar_enabled": "true", "front_camera_enabled": "true"})
    ...
    robot_state_publisher = Node(
        ...
        parameters=[
                    ...
                    # add right camera
                    ' right_camera_enabled:=', right_camera_enabled,
                    ])}],
        remappings=[
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("front_camera_enabled", default_value = front_camera_enabled),
        ...
        # for my own right camera
        DeclareLaunchArgument("right_camera_enabled", default_value = right_camera_enabled), 
