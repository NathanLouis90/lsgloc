...
#include "semantic_msgs/msg/detail/semantic_detection__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = semantic_msgs::msg::SemanticDetection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const semantic_msgs::msg::SemanticDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<semantic_msgs::msg::SemanticDetection *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SemanticDetection__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const semantic_msgs::msg::SemanticDetection *>(
...
static size_t _SemanticDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SemanticDetection(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SemanticDetection__callbacks = {
  "semantic_msgs::msg",
  "SemanticDetection",
...
static rosidl_message_type_support_t _SemanticDetection__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SemanticDetection__callbacks,
...
{
  return &semantic_msgs::msg::typesupport_fastrtps_cpp::_SemanticDetection__handle;
}
