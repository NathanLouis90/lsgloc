...
bool semantic_msgs__msg__semantic_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("semantic_msgs.msg._semantic_detection.SemanticDetection", full_classname_dest, 55) == 0);
  }
  semantic_msgs__msg__SemanticDetection * ros_message = _ros_message;
  {  // label
...
{
  /* NOTE(esteve): Call constructor of SemanticDetection */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("semantic_msgs.msg._semantic_detection");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SemanticDetection");
