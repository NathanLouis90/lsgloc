...
static const _SemanticDetection_type_support_symbol_names_t _SemanticDetection_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, semantic_msgs, msg, SemanticDetection)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, semantic_msgs, msg, SemanticDetection)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, semantic_msgs, msg, SemanticDetection)() {
  return &::semantic_msgs::msg::rosidl_typesupport_c::SemanticDetection_message_type_support_handle;
}
